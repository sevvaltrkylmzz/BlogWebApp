        ...
        <div className="singlePost">
            ...
            <h1 className="singlePostTitle">
                ...
                <div className="singlePostInfo">
                    <span className="singlePostAuthor" >Author: <b>Şevval</b> </span>
                    <span className="singlePostDate" > 1 hour ago </span>
                </div>
                <div className="singlePostDescription">
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam quo quas illo nam beatae amet repellat inventore sapiente iusto enim eos veritatis ex harum, tenetur accusantium in labore sunt consequatur.
